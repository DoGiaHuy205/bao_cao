...
# D23_DoGiaHuy Báo cáo ngày 26/10/2024
...
* đồng thời học mắc mạch cùng với các linh kiện là led, nút bấm, biến trở, cùng code qua [Link](https://nshopvn.com/blog/tai-lieu-arduino-starter-kit-2021/#den-led)
	-led:
...
#### Báo cáo ngày 19/10/2024
-Tiếp tục tìm hiểu về arduino và esp32
* học tiếp các hàm chức năng time
...
* học mắc mạch cùng với các linh kiện là còi buzz thụ động, quang trở, cảm biến nghiêng, cùng code
	-Còi buzz thụ động:
...
#### Báo cáo ngày 26/10/2024
-Tiếp tục tìm hiểu về arduino và esp32
* học mắc mạch cùng với các linh kiện là Led 7 đoạn, màn hình LCD 1602, cùng code
	-Led 7 đoạn:
		...
		+Tìm hiểu sơ đồ chân của led 7 đoạn: ![chân chung là gnd](7doan_gnd.png)
											 ![chân chung là vcc](7doan_vcc.png)
		+Bài tập: Hiển thị các số từ 0 đến 9
				  kết hợp với nút bấm để hiển thị từ 0 đến 9
	-Màn hình LCD:
...
## B. BÀI TẬP
### 5 Bài: Sáng dần tắt dần, giọt nước, cánh bướm, rắn săn mồi, chuyển từ 1 đến 255 sang nhị phân(sáng bằng led)
